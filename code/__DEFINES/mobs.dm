...
#define HYPOXIA_BRAIN_DAMAGE_OXY_THRESHOLD 30
#define HYPOXIA_BRAIN_DAMAGE_INTERVAL (3 SECONDS)
#define HYPOXIA_BRAIN_DAMAGE_BASE 1
#define HYPOXIA_BRAIN_DAMAGE_SCALE 0.1
#define HYPOXIA_BRAIN_DAMAGE_MAX 12
#define HYPOXIA_BRAIN_MESSAGE_STAGE_1 BRAIN_DAMAGE_SEVERE
#define HYPOXIA_BRAIN_MESSAGE_STAGE_2 (BRAIN_DAMAGE_DEATH - 20)
#define HYPOXIA_BRAIN_MESSAGE_STAGE_3 (BRAIN_DAMAGE_DEATH - 5)
