...
#define PRONOUNS_LIST list(HE_HIM, SHE_HER)
#define PRONOUNS_LIST_NO_IT list(HE_HIM, SHE_HER)
...
#define VOICE_TYPES_LIST list(VOICE_TYPE_MASC, VOICE_TYPE_FEM)

#define VOICE_TYPES_MASCANDRO list(VOICE_TYPE_MASC)
#define VOICE_TYPES_FEMANDRO list(VOICE_TYPE_FEM)
