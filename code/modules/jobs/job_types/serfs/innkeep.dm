/datum/job/innkeep
	title = "Innkeep"
	tutorial = "Gençliğini kan ve vahşet ile geçirdin, ama artık o zamanlar geride kaldı. \
		Artık bir han işletiyorsun, alkol, yemek ve konaklama sağlayarak geçimini sağlıyorsun. \
		Ama geçmişin şeytanları peşini bırakmadı, hala paralı asker loncasına çalışıyor, üyelerinin iş bulmasına yardım ediyor, ve birbirlerini öldürmediklerinden emin oluyorsun. \
		Unutma, kimse bardakları dolduran adama ters yapamaz."
