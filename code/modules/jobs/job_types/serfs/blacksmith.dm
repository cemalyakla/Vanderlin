...
/datum/job/blacksmith
	title = "Blacksmith"
	tutorial = "Yıllarca efendinin yanında demirciliğin sırlarını ve püf noktalarını öğrendin, \
	Çeliği bükmeyi ve şekil vermeyi kendine sanat edindin. \
	Artık kasabanın şefinin bıçaklarını tamir ediyor, milislerin kılıçlarını keskinleştiriyorsun, ve bundan gurur duyuyorsun."
	department_flag = SERFS
	job_flags = (JOB_ANNOUNCE_ARRIVAL | JOB_EQUIP_RANK | JOB_NEW_PLAYER_JOINABLE)
	faction = FACTION_TOWN
	total_positions = 1
